...
;!function(win){
  ...
  ,modules = {
    ...
    ,transfer: 'modules/transfer' //上傳
    ,tree: 'modules/tree' //樹結構
    ,table: 'modules/table' //表格
    ,element: 'modules/element' //常用元素操作
    ,rate: 'modules/rate'  //評分組件
    ,colorpicker: 'modules/colorpicker' //顏色選擇器
    ,slider: 'modules/slider' //滑塊
    ...
    ,mobile: 'modules/mobile' //移動大模塊 | 若當前為開發目錄，則為移動模塊入口，否則為移動模塊集合
    ,'layui.all': '../layui.all' //PC模塊合併版
  };
  ...
  Layui.prototype.use = function(apps, callback, exports){
    ...
    //如果引入了完整庫（layui.all.js），內置的模塊則不必再加載
    if(apps.length === 0
